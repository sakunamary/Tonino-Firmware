...
tcs3200_raw::tcs3200_raw(uint8_t S0, uint8_t S1, uint8_t S2, uint8_t S3, uint8_t output)
{
	pinMode(S0, OUTPUT);
	pinMode(S1, OUTPUT);
	pinMode(S2, OUTPUT);
...
int tcs3200_raw::colorRead(char color, int scaling)
{
...
String tcs3200_raw::closestColor(int distinctRGB[][3], String distinctColors[], int num_of_colors)
{
...
int tcs3200_raw::closestColor(int distinctRGB[][3], int distinctColors[], int num_of_colors)
{
...
int tcs3200_raw::closestColorIndex(int distinctRGB[][3], int num_of_colors)
{
